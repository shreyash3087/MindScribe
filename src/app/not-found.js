            ...
            <main className={`h-screen w-full ${
                ...
                >
                    <defs>
                        ...
                        >
                            <rect
                                style={{ fill: isDarkMode ? "white" : "black", stroke: "none" }}
                                x="0"
                                y="-0.5"
                                width="1"
                                height="2"
                    ...
                    <g transform="translate(170.14515,0.038164)" id="layer1">
                        <g id="g6219" className="origin-[85px_4px] animate-pendulum">
                            <path
                ...
                <p className={`text-2xl my-4 ${isDarkMode ? "text-white" : "text-black"}`}>O-o-oh! Something broke.</p>
                <Link
                    href="/"
                    className={`text-xl py-3 px-4 border ${isDarkMode ? "border-white text-white hover:bg-white hover:text-black" : "border-black text-black hover:bg-black hover:text-white"} transition-all duration-500`}
                >
                    Go Back
                </Link>
            </main>
