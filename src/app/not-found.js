  ...
  return (
    <>
      <main className="h-screen w-full bg-white flex flex-col justify-center items-center">
        ...
        <p className="text-2xl my-4">O-o-oh! Something broke.</p>
        <Link
          href="/"
          className="text-xl py-3 px-4 border border-black text-black hover:bg-black hover:text-white transition-all duration-500"
        >
          Go Back
        </Link>
      </main>
